...
Route::add(['GET', 'POST'],'/disciplinesSearch', [Controller\Employees::class, 'searchDisciplines'])->middleware('auth', 'roleEmployees');
Route::add(['GET', 'POST'],'/addDisciplineGroupe', [Controller\Employees::class, 'addDisciplineGroupe'])->middleware('auth', 'roleEmployees');
Route::add(['GET', 'POST'], '/groups/group', [Controller\Employees::class, 'groupInf'])->middleware('auth', 'roleEmployees');
Route::add(['GET', 'POST'],'/disciplineFiltering', [Controller\Employees::class, 'disciplineFiltering'])->middleware('auth', 'roleEmployees');
Route::add(['GET', 'POST'],'/student', [Controller\Employees::class, 'vueStudent'])->middleware('auth', 'roleEmployees');
Route::add('GET','/disciplines', [Controller\Employees::class, 'disciplines'])->middleware('auth', 'roleEmployees');
Route::add(['GET', 'POST'],'/gradeStudents', [Controller\Employees::class, 'gradeStudents'])->middleware('auth', 'roleEmployees');
